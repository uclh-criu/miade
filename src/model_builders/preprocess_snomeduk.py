...
class Snomed:
    ...
    def to_concept_df(self):
        ...
        for i, snomed_release in enumerate(snomed_releases):
            ...
            int_desc = parse_file(f'{contents_path}/sct2_Description_{uk_code}Snapshot-en_{snomed_v}_{snomed_release}.txt')
            ...
            active_snomed_df['type_ids'] = active_snomed_df['description_type_ids'].dropna().apply(
